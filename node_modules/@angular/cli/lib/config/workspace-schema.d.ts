...
export type AngularApplicationOptionsSchema = {
     ...
     * For example, if the prefix is `ag-grid-app` and you generate a component named `my-component`,
     * the selector will be `ag-grid-app-my-component`.
     */
    prefix?: string;
    /**
...
export type AngularNgNewOptionsSchema = {
     ...
     * prefix is `ag-grid-app` and you generate a component named `my-component`, the selector will
     * be `ag-grid-app-my-component`.
     */
    prefix?: string;
    /**
